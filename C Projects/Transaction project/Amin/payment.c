...
/*Operation flags*/
extern unsigned char Expiration_flag;
extern unsigned char Max_amount_flag;
extern unsigned char Account_check_flag;
extern unsigned char Terminal_check_flag;
